        ...
        <nav className="flex items-center justify-between flex-wrap bg-teal-700 p-6">
            ...
            <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
                <div className="text-sm lg:flex-grow">
                    <a href="#responsive-header" className="font-semibold block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                        About
                    </a>
                    <a href="#responsive-header" className="font-semibold block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                        Last Minute Offers
                    </a>
                    <a href="#responsive-header" className="font-semibold block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                        Trending locations
                    </a>
                </div>
                <div>
